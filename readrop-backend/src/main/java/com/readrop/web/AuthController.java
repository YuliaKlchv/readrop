...
import com.readrop.dto.ForgotRequest;
import com.readrop.dto.LoginRequest;
import com.readrop.dto.PublicUser;
import com.readrop.dto.SignupRequest;
import com.readrop.model.AppUser;
import com.readrop.security.CookieService;
import com.readrop.security.JwtService;
...
public class AuthController {
    ...
    public ResponseEntity<Map<String, Object>> signup(
            @RequestBody(required = false) SignupRequest body) {
    ...
    public Map<String, Boolean> forgotPassword(
            @RequestBody(required = false) ForgotRequest body) {
